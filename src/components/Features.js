        ...
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-2 md:gap-12 md:space-y-0">
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">
              Charging Connector Details
            </h3>
            <p className="text-gray-500 dark:text-gray-400">
              Users can view information about the types of connectors available
              at the charging station, their total count, available count,
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Users can also enjoy a visual preview of the charging station
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Users can receive directions to the charging station&apos;s
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Users can access the website link associated with the charging
